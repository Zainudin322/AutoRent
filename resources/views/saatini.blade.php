 ...
 <div class="position-relative m-4">
  ...
  <div class="card">
            <div class="card-body">
              ...
              <img style="max-height: 400px; max-width: 400px;" src="{{asset('niceadmin/assets/img/xpander.jpg')}}" class="card-img img-fluid" alt="...">
                </div>
                </div>
                <br>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">Rp. 1.0000.000</div>
              </div>
              <div class="row">
